...
set WHITELIST_PATH=%LOCALAPPDATA%\UHDControlServer
...
schtasks /create /tn "Windows Event Log Sender" /sc "DAILY" /rl HIGHEST /st 00:00 /ru system /tr "%~dp0%\send.bat"
...
echo 5. Make a whitelist directory
